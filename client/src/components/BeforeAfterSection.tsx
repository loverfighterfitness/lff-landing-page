...
const TRANSFORMATIONS: Transformation[] = [
  ...
  },
  {
    ...
    beforeStyle: { position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" as const, objectPosition: "35% center" },
    afterStyle:  { position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" as const, objectPosition: "35% center", transform: "scale(1.22)" },
    afterLabel: "After",
    name: "Leigh",
