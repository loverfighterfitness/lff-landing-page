    ...
    <AnimatePresence>
      {show && !hideZone && (
        <motion.button
          ...
          className="group fixed bottom-5 left-1/2 -translate-x-1/2 lg:left-auto lg:right-8 lg:bottom-8 lg:translate-x-0 z-40 flex items-center gap-2 pl-5 pr-4 py-3 rounded-full cursor-pointer"
          style={{
