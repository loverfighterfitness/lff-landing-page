...
const Y_TICK_VALUES = Array.from(
  { length: 9 },
  (_, i) => (i + 1) * (Y_DOMAIN[1] / 10)
);
...
export const Axes: React.FC = () => {
  ...
  const yGrow = interpolate(t, [0, 22], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  const xGrow = interpolate(t, [12, 38], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  const tickFade = interpolate(t, [30, 52], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  const labelFade = interpolate(t, [40, 62], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
